    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _StadiumTile(
          ...
          onTap: () => context.pushNamed(AppRoutes.detailStadium, extra: stadium.id),
        );
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(
        ...
        style: TextStyle(fontWeight: FontWeight.w700, fontSize: deviceHeight * 0.02),
      ),
      subtitle: Text(
...
class _SavedStadiumsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SavedStadiumsCubit, SavedStadiumsState>(
      builder: (context, state) {
        return switch (state) {
          SavedStadiumsLoading() => const Center(child: CircularProgressIndicator()),
          SavedStadiumsLoaded(:final savedStadiums) => savedStadiums.isEmpty
              ? const Center(child: Text("Saqlangan stadionlar yo'q"))
  ...
  Widget _buildBottomSheetContent(BuildContext context, List<StadiumDetail> savedStadiums) {
    return Padding(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () => context.read<SavedStadiumsCubit>().removeStadiumFromSaved(stadium),
                  ),
                );
              },
            ),
